...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示Your app was successfully deployed  
  ...
  * 点击View跳转[欢迎页面](https://github.com/mixool/lazyku/blob/master/etc/CADDYIndexPage.md)域名即为heroku分配的项目域名，格式为`appname.herokuapp.com`，客户端会用到此域名  
...
> [更多来自热心网友PR的使用教程](https://github.com/mixool/lazyku/tree/master/tutorial)
